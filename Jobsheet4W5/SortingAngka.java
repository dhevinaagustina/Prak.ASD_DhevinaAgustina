...
public class SortingAngka{
    // Metode bubbleSort untuk mengurutkan array angka menggunakan algoritma Bubble Sort
    ...
    // Metode selectionSort untuk mengurutkan array angka menggunakan algoritma Selection Sort
    public static int[] selectionSort(int[] numbers) {
        ...
        for (int i = 0; i < n - 1; i++) {
            ...
            // Loop untuk menemukan elemen dengan nilai terkecil di antara elemen yang belum diurutkan
            for (int j = i + 1; j < n; j++) {
                // Bandingkan elemen saat ini dengan elemen di minIndex
                if (numbers[j] < numbers[minIndex]) {
                    // Jika elemen saat ini lebih kecil, perbarui minIndex ke posisi saat ini
                    minIndex = j;
                }
            }
    ...
    // Metode insertionSort untuk mengurutkan array angka menggunakan algoritma Insertion Sort
    public static int[] insertionSort(int[] numbers) {
        ...
        for (int i = 1; i < n; i++) {
            ...
            // Pindahkan elemen array yang lebih besar dari kunci ke satu posisi ke depan dari posisi saat ini
    ...
    public static void main(String[] args) {
        ...
        // Urutkan my1stNumbers menggunakan metode bubbleSort
        ...
        // Urutkan my2ndNumbers menggunakan metode selectionSort
        ...
        // Urutkan my3rdNumbers menggunakan metode insertionSort
